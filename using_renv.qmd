...
2) renv::install can also install specific versions of packages, e.g. renv::install("https://cran.r-project.org/src/contrib/Archive/kyotil/kyotil_2024.7-31.tar.gz")
]{style="font-size: 0.6em"}


## Troubleshooting

- We recommend using the directory containing renv.lock as the working directory to avoid certain errors. 
